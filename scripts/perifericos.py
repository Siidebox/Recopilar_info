...
def clasificar_dispositivo(descripcion):
    ...
    if any(
        keyword in descripcion_lower for keyword in ["keyboard", "teclado", "input"]
    ):
        return "Entrada"
        ...
        for keyword in ["audio", "speaker", "headset", "micrófono", "microphone"]
    ):
        return "Audio"
        ...
        keyword in descripcion_lower
        for keyword in ["usb drive", "storage", "disk", "almacenamiento"]
    ):
...
def obtener_perifericos_linux():
    ...
    if comando_disponible("lsusb"):
        try:
            ...
            print(
                f"Error al ejecutar 'lsusb': {e}. Puede que no haya dispositivos conectados o el comando haya fallado."
            )
    else:
        print(
            "Advertencia: 'lsusb' no está instalado. No se pueden obtener dispositivos USB."
        )
    ...
    if comando_disponible("lshw"):
        ...
        print(
            "Advertencia: 'lshw' no está instalado. No se pueden obtener dispositivos adicionales."
        )
...
def main():
    ...
    if dispositivos:
        ...
        print(
            "No se encontraron periféricos conectados. Se ha creado un archivo vacío."
        )
